...
var decodeObject = function (obj, opts) {
    ...
    for (var i = 0; i < keys.length; ++i) {
        var key = opts.decoder(keys[i], defaults.decoder, opts.charset, 'key');
        var val = opts.decoder(obj[key], defaults.decoder, opts.charset, 'value');
        val = utils.maybeMap(val, function (mapped) {
